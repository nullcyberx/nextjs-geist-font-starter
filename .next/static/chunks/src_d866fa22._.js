...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!loginRes.ok) {
                throw new Error('Registration successful but failed to login');
            }
...
_s(RegisterPage, "w42C1VDSAZJiphkroM/6lHhLwv8=", false, function() {
    return [
...
//# sourceMappingURL=src_d866fa22._.js.map